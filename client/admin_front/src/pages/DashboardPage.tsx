...
function getPrescriptionStatusClass(status?: string) {
  if (status === "issued") return "bg-primary/10 text-primary border-primary/20";
  if (status === "dispensed") return "bg-green-100 text-green-700 border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800";
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-muted-foreground md:text-base">
                Here’s a real-time overview of your healthcare platform, including
                doctors, prescriptions, centers, and patient activity.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Latest prescription activity from the live system.
                </p>
              </div>
          ...
          <CardContent className="pt-4">
            {loading ? (
              ...
              <div className="rounded-2xl border border-dashed p-10 text-center">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Recent prescription records will appear here.
                </p>
              </div>
            ) : (
              <div className="space-y-3">
                {recentPrescriptions.map((rx) => (
                  <div
                    key={rx._id || rx.id || rx.prescriptionNo}
                  ...
                  >
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Badge
                          variant="secondary"
                          className={`rounded-full border px-3 py-1 text-[11px] ${getPrescriptionStatusClass(rx.status)}`}
                        >
                          {rx.status || "unknown"}
                        </Badge>
                      </div>
                    ...
                    <Link to="/prescriptions" className="shrink-0">
                      <Badge variant="outline" className="rounded-full px-3 py-1">
                        Open
                      </Badge>
                    </Link>
        ...
        <div className="space-y-5">
          <Card className="rounded-3xl border shadow-sm">
            <CardHeader className="pb-2">
              ...
              <p className="text-sm text-muted-foreground">
                Account summary for the current signed-in administrator.
              </p>
            </CardHeader>
          ...
          <Card className="rounded-3xl border shadow-sm">
            <CardHeader className="pb-2">
              ...
              <p className="text-sm text-muted-foreground">
                Quick summary of the current live system.
              </p>
            </CardHeader>
            ...
            <CardContent className="pt-4">
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between rounded-2xl border bg-muted/20 px-4 py-3">
                  <span className="text-sm text-muted-foreground">Centers</span>
                  <span className="text-sm font-semibold">
