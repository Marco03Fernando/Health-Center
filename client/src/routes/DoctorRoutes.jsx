...
export default function DoctorRoutes() {
    return (<Routes>
      ...
      <Route path="profile" element={<DoctorProtectedRoute>
            <DoctorProfilePage />
          </DoctorProtectedRoute>}/>
      <Route path="patients" element={<DoctorProtectedRoute>
            <DoctorPatientsPage />
          </DoctorProtectedRoute>}/>
      <Route path="prescriptions" element={<DoctorProtectedRoute>
            <DoctorPrescriptionsPage />
          </DoctorProtectedRoute>}/>
      <Route path="appointments" element={<DoctorProtectedRoute>
