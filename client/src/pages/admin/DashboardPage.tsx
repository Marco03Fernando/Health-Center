...
export default function AdminDashboardPage() {
  ...
  const totalPatients   = useMemo(() => {
    ...
    prescriptions.forEach((p) => { if (p.userId?._id) ids.add(p.userId._id); });
    return ids.size;
  }, [prescriptions]);
            ...
            <CardContent className="pt-4">
              <div className="space-y-3">
                {[
                  ...
                  <div key={row.label} className="flex items-center justify-between rounded-2xl border bg-muted/20 px-4 py-3">
