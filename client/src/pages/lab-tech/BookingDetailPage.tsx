...
export default function LabTechBookingDetailPage() {
  ...
  async function handleCancel() {
    ...
    try {
      ...
      setBooking((prev) =>
        prev ? { ...prev, appointmentStatus: "CANCELLED" } : null
      );
    ...
    <div className="space-y-8 p-1 md:p-2">
      ...
      <div className="flex items-center gap-3">
        <Button
          ...
          size="sm"
          className="rounded-xl"
          onClick={() => navigate("/lab-tech/lab-bookings")}
        >
          <ArrowLeft className="mr-2 h-4 w-4" />
          Lab Bookings
        </Button>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              ...
              <DetailRow
                icon={Mail}
                label="Email"
                value={booking.user?.email || null}
              />
              <DetailRow
                icon={Phone}
                label="Phone"
                value={booking.user?.phone || null}
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              <DetailRow
                ...
                label="Date"
                value={formatDate(
                  booking.slot?.slotDate || booking.appointmentDate
                )}
              />
              <DetailRow
                icon={Clock}
              ...
              <DetailRow
                icon={MapPin}
                label="Lab Center"
                value={booking.healthCenter?.name || null}
              />
              <DetailRow
                icon={MapPin}
                label="Address"
                value={booking.healthCenter?.address || null}
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              <DetailRow
                icon={FlaskConical}
                label="Test Name"
                value={booking.diagnosticTest.name || null}
              />
