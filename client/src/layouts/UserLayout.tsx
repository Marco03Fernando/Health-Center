    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="hidden lg:flex flex-col w-64 border-r border-border bg-card fixed h-full z-30">
        ...
        <div className="p-3 border-t border-border">
          <button
            onClick={() => { logout(); navigate("/user/auth"); }}
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 w-72 bg-card border-r border-border z-50 transform transition-transform lg:hidden",
      ...
      >
        ...
        <div className="p-3 border-t border-border">
          <button
            onClick={() => { logout(); navigate("/user/auth"); setMobileOpen(false); }}
